        ...
        if (task_switch)
        {
            ...
            if(atc.arm_task_init)
            {
                ...
                else if (atc.mode == 2)
                {
                    ...
                    tocabi_.link_[COM_id].Set_Trajectory_from_quintic(control_time_, atc.command_time, atc.command_time + atc.traj_time);
                    tocabi_.link_[COM_id].Set_Trajectory_rotation(control_time_, atc.command_time, atc.command_time + atc.traj_time, false);
